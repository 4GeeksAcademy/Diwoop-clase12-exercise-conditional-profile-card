...
function render(variables = {}) {
  ...
  document.getElementById("lastName").innerHTML = variables.lastName;
  ...
  if (twitterInput && githubInput && linkedinInput && instagramInput) {
    let twitterValue = twitterInput.value;
    let githubValue = githubInput.value;
    let linkedinValue = linkedinInput.value;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h2>${role.value}</h2>
          <h3>${country.value} ${city.value}</h3>
